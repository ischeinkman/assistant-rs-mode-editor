...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "/** Wrapper styling **/\n.commandEditorView {\n  justify-content: space-between;\n}\n\n/** Field table entries **/\n.commandEditorView .fieldRow {\n  margin-left: 10px;\n  margin-right: 10px;\n  margin-bottom: 10px;\n\n  text-align: center;\n  flex-grow: 1;\n\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-content: center;\n}\n\n.commandEditorView .fieldLabel {\n  text-align: center;\n  justify-self: center;\n  align-self: center;\n  height: min-content;\n  font-family: sans-serif;\n  font-weight: bold;\n}\n\n.commandEditorView .fieldEditor {\n  align-self: center;\n  align-items: right;\n  justify-items: center;\n  flex-grow: 1;\n  max-width: 70%;\n  max-height: min-content;\n}\n\n.commandEditorView .fieldEditor input {\n  width: 100%;\n}\n\n/** Push down the top row **/\n.commandEditorView .messageRow {\n  margin-top: 10px;\n}\n\n/** Next mode is editting is done via separate list view instead of raw input text;\ntherefore, it needs some extra custom stylings **/\n.commandEditorView .modeEditor {\n  display: flex;\n  flex-direction: row;\n}\n\n.commandEditorView .modeLabel {\n  flex-grow: 1;\n  align-self: center;\n  font-family: sans-serif;\n}\n\n.commandEditorView .modeChangeButton {\n  align-self: center;\n  padding-left: 10px;\n  padding-right: 10px;\n  padding-top: 3px;\n  padding-bottom: 3px;\n}\n", "",{"version":3,"sources":["command_editor.css"],"names":[],"mappings":"AAAA,sBAAsB;AACtB;EACE,8BAA8B;AAChC;;AAEA,0BAA0B;AAC1B;EACE,iBAAiB;EACjB,kBAAkB;EAClB,mBAAmB;;EAEnB,kBAAkB;EAClB,YAAY;;EAEZ,aAAa;EACb,mBAAmB;EACnB,8BAA8B;EAC9B,qBAAqB;AACvB;;AAEA;EACE,kBAAkB;EAClB,oBAAoB;EACpB,kBAAkB;EAClB,mBAAmB;EACnB,uBAAuB;EACvB,iBAAiB;AACnB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,qBAAqB;EACrB,YAAY;EACZ,cAAc;EACd,uBAAuB;AACzB;;AAEA;EACE,WAAW;AACb;;AAEA,4BAA4B;AAC5B;EACE,gBAAgB;AAClB;;AAEA;iDACiD;AACjD;EACE,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,kBAAkB;EAClB,mBAAmB;EACnB,gBAAgB;EAChB,mBAAmB;AACrB","file":"command_editor.css","sourcesContent":["/** Wrapper styling **/\n.commandEditorView {\n  justify-content: space-between;\n}\n\n/** Field table entries **/\n.commandEditorView .fieldRow {\n  margin-left: 10px;\n  margin-right: 10px;\n  margin-bottom: 10px;\n\n  text-align: center;\n  flex-grow: 1;\n\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n  align-content: center;\n}\n\n.commandEditorView .fieldLabel {\n  text-align: center;\n  justify-self: center;\n  align-self: center;\n  height: min-content;\n  font-family: sans-serif;\n  font-weight: bold;\n}\n\n.commandEditorView .fieldEditor {\n  align-self: center;\n  align-items: right;\n  justify-items: center;\n  flex-grow: 1;\n  max-width: 70%;\n  max-height: min-content;\n}\n\n.commandEditorView .fieldEditor input {\n  width: 100%;\n}\n\n/** Push down the top row **/\n.commandEditorView .messageRow {\n  margin-top: 10px;\n}\n\n/** Next mode is editting is done via separate list view instead of raw input text;\ntherefore, it needs some extra custom stylings **/\n.commandEditorView .modeEditor {\n  display: flex;\n  flex-direction: row;\n}\n\n.commandEditorView .modeLabel {\n  flex-grow: 1;\n  align-self: center;\n  font-family: sans-serif;\n}\n\n.commandEditorView .modeChangeButton {\n  align-self: center;\n  padding-left: 10px;\n  padding-right: 10px;\n  padding-top: 3px;\n  padding-bottom: 3px;\n}\n"]}]);
// Exports
